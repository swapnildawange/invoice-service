...
// Source: github.com/invoice-service/user (interfaces: BL)
...
func (m *MockBL) DeleteUser(arg0 context.Context, arg1 spec.DeleteUserReq) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockBL) GetUser(arg0 context.Context, arg1 int) (spec.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBLMockRecorder) GetUser(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUser", reflect.TypeOf((*MockBL)(nil).GetUser), arg0, arg1)
}
